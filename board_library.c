...
/*returns pointer to card referenced by coordinates i and j*/
char * get_board_place_str(int i, int j){
  return board[linear_conv(i, j)].v;
}


/*creates dim*dim board and assigns each card a string
after termination the board has all cards initialized*/
